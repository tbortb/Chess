...
public class PiecesCenterAndPawns implements ChessBoardEvaluator {

	@Override
	public int evaluatePosition(ChessBoard chessBoard) {
		// White is trying to get a high score, while balck is trying to get a negative
		// score
		int points = 0;
		int center33 = 0;
		int center34 = 0;
		...
		for (ChessPiece piece : chessBoard.getWhitePieces()) {
			...
			if (chessBoard.getLogSize() <= 30) {
				...
				if (piece instanceof Pawn) {
					points += 8 - piece.getField().getRow();
				}
			}
		}
